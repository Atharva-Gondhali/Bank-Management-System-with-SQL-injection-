...
public class GUI {
	...
	public void openSignInForm(JFrame frame, Login_Account user) {
		...
		// main screen picture
		JLabel imgLabel = new JLabel(new ImageIcon(  "C:\\Users\\athar\\IdeaProjects\\Bank-Management-System\\BM_System\\src\\def_pkg\\anchor.png"));
	...
	void open_Signup_form_1(JFrame frame, Login_Account user)
	{
		...
		JLabel l_Aadhar = new JLabel("Enter the Aadhar:");
		l_Aadhar.setBounds(200, 180, 100, 90);
		f.add(l_Aadhar);
		...
		tf_Aadhar.setBounds(350,210,200, 25);
		f.add(tf_Aadhar);
		...
		btn_Verify_Account.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					...
					int verify_status = user.verify_account(tf_AccountNo.getText(), tf_Aadhar.getText());
					...
					{
						// System.out.println("The Aadhar matched with the client having client id=" + temp_client_id);
						open_Signup_form_2(frame, user, tf_AccountNo.getText());
					}
					else
					{
						JOptionPane.showMessageDialog(f, "No account found with this Aadhar");
						// **************************************
						System.out.println("The Aadhar did not match with any client");
						frame.remove(f);
						frame.repaint();
						frame.validate();
						openSignInForm(frame, user);
	...
	public void openCreateAccountForm(JFrame frame, Manager manager) {
		...
		f.add(l_motherName);
		JLabel l_cnic = new JLabel("Aadhar: ");
	...
	void searchAccount(JFrame frame, Manager manager) {
		...
		// Client Aadhar
		JLabel lCAadhar = new JLabel("Aadhar: ");
		lCAadhar.setBounds(150,200,250, 40);
		lCAadhar.setVisible(false);
		f.add(lCAadhar);
		...
		btnSearch.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if( (account.getAccountNum().compareTo("") == 0) || (client.getAadhar().compareTo("") == 0 ) ) {
					...
					else if (client.getAadhar().compareTo("") == 0 ) {
				...
				// Both client and his account was found
					...
					lCAadhar.setText("Aadhar:  "+client.getAadhar() );
	...
	void depositCash(JFrame frame, Accountant accountant, Client client, Bank_Account account) {
		...
		// Aadhar Label
		JLabel lCnic = new JLabel( "Aadhar: " + client.getAadhar() );
