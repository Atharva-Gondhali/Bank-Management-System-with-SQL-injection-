...
public class Accountant {
	...
	Bank_Account searchAccount1(String accountNum, String Aadhar) {
		...
		Bank_Account account = db.searchAccount1(accountNum, Aadhar);
		db = null;
	...
	public Client searchClient1(String accountNum, String Aadhar) {
		DB_Handler db = new DB_Handler();
		Client client = db.searchClient1( accountNum, Aadhar );
		db = null;
		return client;
	}
